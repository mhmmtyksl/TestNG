...
public class C03_SoftAssert {
    ...
    public void test() {
        ...
        driver.navigate().back(); // sayfadaki guvenlik problemi icin yaptik bunu

        // 6. Pay Bills sayfasina gidin
        driver.findElement(By.xpath("//strong[text()='Online Banking']")).click();// hemen acilmadi once online banking e tikladik
        ...
        SoftAssert softAssert=new SoftAssert();// burda softAssert objesi olusturuyoruz
